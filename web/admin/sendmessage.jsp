    ...
    if (request.getParameter("sendmsg") != null) {
        ...
        if (msgtext.isEmpty()) {
            ...
            if (reciver.equals("inspector")) {
                String sql = "INSERT INTO inspector_message(sender, message, zone, status, date) VALUES ('adminstrator','" + msgtext + "','" + zone + "','0','" +formattedDate  + "')";
                ...
                String sql = "INSERT INTO policeofficer_message(sender, message, zone, status, date) VALUES ('adminstrator','" + msgtext + "','" + zone + "','0','" + formattedDate + "')";
                query = st.executeUpdate(sql);
                if (query > 0) {
                    out.println("<font style='color:red; font-size:20px; position:absolute;left:600px; top:400px;'> message sent sucessfully</font>");
                } else {
                ...
                String sql = "INSERT INTO comissioner_message(sender, message, zone, status, date) VALUES ('adminstrator','" + msgtext + "','" + zone + "','0','" + formattedDate + "')";
                query = st.executeUpdate(sql);
                if (query > 0) {
                    out.println("<font style='color:red; font-size:20px; position:absolute;left:600px; top:400px;'> message sent sucessfully</font>");
                } else {
