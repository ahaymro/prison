...
<table class="table table-bordered ">
  <tr>
    ...
    <tr style="text-align: center;"><td style="font-size: 20px; background-color: LightSteelBlue; color: white; font-family: comic sans Ms;">do you know about BG</td>
        <td style="font-size: 20px; background-color:LightSteelBlue; color: black; font-family: comic sans Ms;" >show deactivate account</td>
...
String sql2="select *from account where status=0";
...
<tr>
    ...
    <td><a href='activated.jsp?id=<%= rs.getString("ssn") %>'>activate</a></td>
</tr>
...
<font style='color:red; font-size:20px; margin-left:70px;'>no deactivated account!</font>
...
if (request.getParameter("update") != null) {
  ...
  if (newPwd.equals(copassword)) {
    ...
    if (report>0) {
      ...
      int query=stmt.executeUpdate(sql5);
      if (query>0) {
