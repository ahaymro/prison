...
if (request.getParameter("send") != null) {
    ...
    try {
        ...
        String sql = "INSERT INTO feedback( sender, comment, date, zone, status) VALUES (?,?,?,?,?)";
        ps = con.prepareStatement(sql);
        ps.setString(1, "policeofficer");
        ps.setString(2, comment);
        ps.setString(3, new java.sql.Date(new java.util.Date().getTime()).toString());
        ps.setString(4, zone);
        ps.setInt(5, 0);
...
%>)</span></a></li>
      <li><a href="inbox.jsp"><span style="color: black; font-size: 20px;">old message</span></a></li>  
		...
		<li><a href="sendmessage.jsp">send message</a></li>
            <li><a href="view_visitor.jsp">visitor appontiment</a></li>    
...
<table class="table table-bordered ">
  <tr><td colspan="3" style="text-align: center; font-family: Comic sans Ms; background-color: #708090; color: white; border-radius: 10px; font-size: 20px; ">welcome to police officer page</td></tr>
    <tr style="text-align: center;"><td style="font-size: 20px; background-color: LightSteelBlue; color: white; font-family: comic sans Ms;">do you know about BG</td>
        <td style="font-size: 20px; background-color: LightSteelBlue; color: black; font-family: comic sans Ms;" >give feedback page </td>
...
<form action="" method="post">
  <table class="table table-bordered">
  <tr><td><br><br>
    <textarea placeholder="Enter your Feedback" class="form-control" style="border:2px solid gray; font-size: 20px;" rows="9" name="comment"></textarea></td>   </tr>
 
<tr><td><input type="submit" name="send" class="btn btn-success form-control" value="send" style="color: white; background-color: #3e8e41;"></td></tr>
