...
%>)</span></a></li>
      <li><a href="inbox.jsp"><span style="color: black; font-size: 20px;">old message</span></a></li>  
		...
		<li><a href="sendmessage.jsp">send message</a></li>
            <li><a href="view_visitor.jsp"> visitor appotiment</a></li>    
...
<table class="table table-bordered ">
    ...
    <tr style="text-align: center;"><td style="font-size: 20px; background-color: LightSteelBlue; color: white; font-family: comic sans Ms;">do you know about BG</td>
        <td style="font-size: 20px; background-color: LightSteelBlue; color: black; font-family: comic sans Ms;" > visitor appointment</td>
...
String sql4="select * from visitor_appo";
...
<table class='table table-bordered'>
    ...
    <tr>
        ...
        <td><%=rs.getString("prisoner_name")%></td>
        <td><%=rs.getString("start_time")%></td>
        <td><%=rs.getString("end_time")%></td>
     <td><a href="remove_app.jsp?id=<%= rs.getString("prisoner_id") %>">remove</a></td>
    </tr>
    <%
    }
    %>
...
%>
<font style='color:red;font-size:20px;'>no appointment</font>
<%
}
%>
