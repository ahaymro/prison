	...
	<div class="navbar navbar-inverse" style="margin-top: 7px;">
      ...
      <li><a href="inbox.jsp"><span style="color: black; font-size: 20px;">old message</span></a></li>  
		...
		<li><a href="sendmessage.jsp">send message</a></li>
                ...
                <li><a href="registervistor.jsp">register vistor</a></li>
...
<table class="table table-bordered ">
  <form action="search.jsp" method="post"><tr><td></td> <td><input type="text" name="fname" class="form-control" style="width: 400px; font-size: 20px; font-family: comic sans ms; border: 3px solid black; border-radius: 5px;" placeholder="search prisoner using first name"></td> <td><input type="submit" name="search" value="search" class="btn btn-info form-control"></td> </tr></form>
  <tr>
