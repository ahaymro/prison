...
if (sessio.getAttribute("username") ==null && sessio.getAttribute("comissioner_logged") == null) {
...
<li><a href="search.php"><span style=" font-size: 25px;">Search prisoner</span></a></li>
      ...
      <tr><td>parent_phone</td><td></td></tr>
       <tr><td>region</td><td></td></tr>
        ...
        <tr><td>release date</td><td></td></tr>
           <tr><td colspan="2"><a href="index.php"><button class="btn btn-danger">back</button></a></td></tr>
</table>
