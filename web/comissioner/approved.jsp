...
String sql1 = "INSERT INTO policeofficer_message(sender,message,status,date) VALUES ('comissioner','your request is accepted!','0','" + new java.sql.Date(System.currentTimeMillis()) + "')";
