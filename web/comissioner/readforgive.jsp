...
<table class="table table-bordered ">
  ...
  <tr>
    ...
    <tr style="text-align: center;"><td style="font-size: 20px; background-color: LightSteelBlue; color: white; font-family: comic sans Ms;">do you know about BG</td>
        <td style="font-size: 20px; background-color: LightSteelBlue; color: black; font-family: comic sans Ms;" >see forgiveness page</td>
        <td style="font-size: 20px; background-color: LightSteelBlue; color: white; font-family: comic sans Ms;"></td></tr>
        <tr><td class="text-justify" style="font-size: 14px;">  Benishangul-Gumuz is one of the nine ethnic divisions (kililoch) of Ethiopia. It was previously known as Region 6.The region's capital is Assosa<br>
            <img src="../assosa 1.jpg" width="100%"></td> 
            <td style="width: 450px;" class="text-justify" rowspan="3">
               <%

String sql4="select * from forgive where status=0";
...
<table class='table table-bordered'>
    ...
    <tr>
        ...
        <td><a href="approved.jsp?id=<%= rs.getString("id") %>">approve</a></td>
        <td><a href="disapproved.jsp?id=<%= rs.getString("id") %>">disapprove</a></td>
    </tr>
    </tr>
    <%
    }
