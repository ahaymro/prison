...
<table class="table table-bordered ">
  ...
  Class.forName("com.mysql.jdbc.Driver");
 con = DriverManager.getConnection("jdbc:mysql://localhost:3306/prisoner", "root", "");
String sql4="select * from comissioner_message where status=0";
...
<table class='table table-bordered'>
    ...
    <tr>
        ...
        <td><a href='read.jsp?id=<%=rs.getInt("id")%>' style='color:red; font-size:20px;'>read</a></td>
    </tr>
    <%
    }
    %>
...
<td style="font-size: 25px; color: red; font-family: agency fb;"> you are login as  comissioner!
<table><tr>
  <%
  Class.forName("com.mysql.jdbc.Driver");
 con = DriverManager.getConnection("jdbc:mysql://localhost:3306/prisoner", "root", "");
String ssnno = (String) sessio.getAttribute("ssn");
String sql7 = "select * from comissioner_information where ssn='"+ssnno+"'";
try {
   st = con.createStatement();
