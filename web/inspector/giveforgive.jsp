...
String serial = (String) sessio.getAttribute("ssn");
String zone = (String) sessio.getAttribute("zone");

if (request.getParameter("send") != null) {
    String comment = request.getParameter("forgive");
  

    try {
      
        String sql = "INSERT INTO forgive( sender, message,zone, status,date) VALUES (?,?,?,?,?)";
        ps = con.prepareStatement(sql);
          ps.setString(1, "inspector");
        ps.setString(2, comment);
        ps.setString(3, zone);
        ps.setInt(4, 0);
        ps.setString(5, new java.sql.Date(new java.util.Date().getTime()).toString());
...
<jsp:include page="../language.jsp" />
    ...
    String sql1="select count(message ) as total  from policeofficer_message where status=0";
...
<table class="table table-bordered ">
  <tr><td colspan="3" style="text-align: center; font-family: Comic sans Ms; background-color: #708090; color: white; border-radius: 10px; font-size: 20px; ">welcome to police officer page</td></tr>
    <tr style="text-align: center;"><td style="font-size: 20px; background-color: LightSteelBlue; color: white; font-family: comic sans Ms;">do you know about BG</td>
        <td style="font-size: 20px; background-color: LightSteelBlue; color: black; font-family: comic sans Ms;" >Apply request page </td>
        ...
        <tr><td class="text-justify" style="font-size: 14px; width: 300px;">  Benishangul-Gumuz (Amharic: ቤንሻንጉል ጉሙዝ), also known as Benshangul/Gumuz, is one of the nine ethnic divisions (kililoch) of Ethiopia. It was previously known as Region 6.The region's capital is Assosa<br>
            ...
            <td style="width: 400px;" class="text-justify" rowspan="3">
             <!-- personal information-->
<form action="" method="post">
  <table class="table table-bordered">
    
   <textarea class="form-control" style="border:2px solid gray; margin-top: 30px; height: 150px;" name="forgive" placeholder="please enter the message" required></textarea></td>   </tr>
<tr><td><input type="submit" name="send" class="btn btn-success form-control" value="send request" style="color:white; background-color: #3e8e41;"></td></tr>
...
<td style="font-size: 25px; color: red; font-family:Agency FB">&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;you are login as  police officer!
<table><br><tr><%
  Class.forName("com.mysql.jdbc.Driver");
 con = DriverManager.getConnection("jdbc:mysql://localhost:3306/prisoner", "root", "");
String ssnno = (String) sessio.getAttribute("ssn");
String sql4 = "select * from policeofficer_information where ssn='"+ssnno+"'";
try {
   st = con.createStatement();
 ...
 <div class="modal fade" id="myModal" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
       ...
       <form action="" method="post">  
            <table class="table table-bordered"><tr><td style="font-family: comic sans ms; font-size: 25px;">username</td> <td><input type="text" name="username" class="form-control" style="border:2px solid green"required="" ></td></tr>
