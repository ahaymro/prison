...
<ul class="dropbtn" style="background-color: gray;">
    <div class="dropdown-content">
			...
			<li><a href="inbox.php"><span style="color: black; font-size: 20px;">new message(<%
...
<table class="table table-bordered ">
  ...
  <tr>
    ...
    <tr style="text-align: center;"><td style="font-size: 20px; background-color: LightSteelBlue; color: white; font-family: comic sans Ms;">do you know about BG</td>
        <td style="font-size: 20px; background-color: LightSteelBlue; color: black; font-family: comic sans Ms;" >search prisoner page</td>
...
if (request.getParameter("search") != null) {
    ...
    String sql = "select *from prisoner_information where ssn='" + serial + "'";
...
<table class='table table-bordered'>
    ...
    %>
    <tr>
        <td><%=query.getString("ssn")%></td>
        <td><%=query.getString("fname")%></td>
         <td><%=query.getString("lname")%></td>
        <td><a href='more.jsp?id=<%=query.getString("ssn")%>'><button class='btn btn-info' style='width:100%'>more</button></a></td>
    ...
    %>
      <tr>
        <td colspan='4'>
            <a href='index.jsp'><button class='btn btn-danger'>Back to home</button></a>
        </td>
    </tr>
</table>
<%
...
%>
<font style='color:red;font-size:20px;'>please enter the correct ID number</font>
<%
}
%>
