...
<table class="table table-bordered ">
  ...
  <tr>
    ...
    <tr style="text-align: center;"><td style="font-size: 20px; background-color: LightSteelBlue; color: white; font-family: comic sans Ms;">do you know about BG</td>
        <td style="font-size: 20px; background-color: LightSteelBlue; color: black; font-family: comic sans Ms;" >Update Prisoner page</td>
...
<form action="../prisonerupate" method="post" enctype="multipart/form-data">
   <tr> 
        <td>Id_no<span style="color: red;">*</span></td>
        <td><input type="text" name="id_no" class="form-control" style="border:1px solid gray; color:black; font-size:16px;" value="<%= ssn %>" pattern="/^[A-Za-z'.\s]{1,40}$*$/" required=""></td>
    </tr>
    <tr> 
        <td>Fname<span style="color: red;">*</span></td>
        <td><input type="text" name="fname" class="form-control" style="border:1px solid gray; color:black; font-size:16px;" value="<%= fname %>" pattern="/^[A-Za-z'.\s]{1,40}$*$/" required=""></td>
    </tr>
    <tr>
        <td>Mname<span style="color: red;">*</span></td>
        <td><input type="text" name="mname" class="form-control" style="border:1px solid gray;" value="<%= mname %>" pattern="^[A-Za-z'.\s]{1,40}$" required=""></td>
    </tr>
    <tr>
        <td>Lname<span style="color: red;">*</span></td>
        <td><input type="text" name="lname" class="form-control" style="border:1px solid gray;" value="<%= lname %>" pattern="^[A-Za-z'.\s]{1,40}$" required=""></td>
    </tr>
    <tr>
        <td>Age<span style="color: red;">*</span></td>
        <td><input type="number" name="age" class="form-control" style="border:1px solid gray;" value="<%= age %>" required=""></td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td><input type="double" name="height" class="form-control" style="border:1px solid gray;" value="<%= height %>" required=""></td>
    </tr>
    <tr>
        <td>Face color<span style="color: red;">*</span></td>
        <td>
            <select name="face" class="form-control" style="border:1px solid gray;">
                <option value="black" <%= face.equals("black") ? "selected" : "" %>>Black</option>
                <option value="white" <%= face.equals("white") ? "selected" : "" %>>White</option>
                <option value="white-black" <%= face.equals("white-black") ? "selected" : "" %>>White-Black</option>
            </select>
        </td>
    </tr>
    <tr>
        <td>Education level<span style="color: red;">*</span></td>
        <td><input type="text" name="education" class="form-control" style="border:1px solid gray;" value="<%= education %>" required=""></td>
    </tr>
    <<tr><td>Region<span style='color: red;'>*</span></td><td><select name='region' class='form-control' style='border:1px solid gray;'value="<%= region %>">
...
<tr><td>parent phone<span style='color: red;'>*</span></td><td><input name='parent_phone' class='form-control'style='border:1px solid gray;' value="<%= parent_phone %>" required=''></td></tr>
