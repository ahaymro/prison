...
<table class="table table-bordered ">
  ...
  <tr>
    ...
    <tr style="text-align: center;"><td style="font-size: 20px; background-color: LightSteelBlue; color: white; font-family: comic sans Ms;">do you know about BG</td>
        <td style="font-size: 20px; background-color: LightSteelBlue; color: black; font-family: comic sans Ms;" >generate clearance page</td>
...
<!--register new user-->
              <table class="table table-bordered">
              <tr><th>ID_no</th> <th>Fname</th> <th>Lname</th> <th>status</th></tr>
    <%

String sql7="select * from prisoner_information";
...
%>
    ...
    <tr style='color:black; font-size:16px;'>
        ...
        <td><a href="generated.jsp?id=<%= rs.getString("ssn") %>"target='_blank'>Generate</a></td>
...
%>
<font style='color:red;font-size:20px;'>until now any request is not posted!</font>
<%
}
%>
</td> 
...
String sql3 = "select * from inspector_information where ssn='"+ssnno+"'";
try {
   st = con.createStatement();
