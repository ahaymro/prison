...
<!--register new user-->
              <table class="table table-bordered">
              <tr><th>ID_no</th> <th>Fname</th> <th>Lname</th> <th colspan='2' class='text-center'>status</th></tr>
            <%
...
%>
    ...
    <tr style='color:black; font-size:16px;'>
        ...
        <td><a href='updated.jsp?id=<%= rs.getString("ssn")%>'>update</a></td>
          <td><a href='deleted.jsp?id=<%= rs.getString("ssn")%>'>delete</a></td>
...
%>
<font style='color:red;font-size:20px;'>data not store!</font>
<%
}
%>
            </table>
