...
%>)</a></li><br>
    ...
    <a href="https://www.yahoo.com"><img src="yahoo.png" alt=""width="34%" height="35%"/></a><br>&nbsp;&nbsp;<br>
            ...
            <td class="text-justify" style="font-size: 14px; width: 300px;">  Benishangul-Gumuz (Amharic: ቤንሻንጉል ጉሙዝ), also known as Benshangul/Gumuz, is one of the nine ethnic divisions (kililoch) of Ethiopia. It was previously known as Region 6.The region's capital is Assosa<br>
            <img src="assosa 1.jpg" width="100%"></td> 

            <td style="width: 300px;" class="text-justify" colspan="3">
        <div class="text-justify" style="width: 300px; margin-left: 200px;">  benshangul-gumuz region prison office is located in assosa city. It gives services for civil prisoners of the region. the organization uses manual file system managment, we prefer to change this application to online based system inorder to make easy file managment
</div>
